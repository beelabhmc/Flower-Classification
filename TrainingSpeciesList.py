...
def createBSSTraining(): 
    ...
    BSSJune8TrainIm, BSSJune8TrainSpecies = GeneralTrainingList(BSSJune8Locations, BSSJune8Species, 'BSS_June8_', 'BSS_June8.jpg', BSSJune8Start, BSSJune8End)
    FullTrainIm = BSSMay19TrainIm + BSSMay26TrainIm + BSSJune3TrainIm + BSSJune8TrainIm
    FullTrainSpecies = numpy.concatenate((BSSMay19TrainSpecies, BSSMay26TrainSpecies, BSSJune3TrainSpecies, BSSJune8TrainSpecies), axis = 0)
    return FullTrainIm, FullTrainSpecies
