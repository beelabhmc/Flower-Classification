...
def SpeciesTest(trainingMode):
    ...
    if trainingMode == 5: 
        ...
        metricTrainTransect, speciesTrainTransect = tiledTraining(nonFlowerImgs, nonFlowerSpecies, n, overlap) #get training metrics for transects, non-flower only. 
        ...
        indices = np.random.choice(len(metricTrainTransect), 100) #Randomly choose 50 sample images of non-flowers 
